  ...
  return (
    <header className="gm-header">
      <div className="gm-header-left">
        ...
        <div>
          <h1 className="gm-title">PR <span className="gm-title-accent">Metrics</span></h1>
          <p className="gm-subtitle">Pull request analytics for your organisation</p>
        </div>
      </div>
      <div className="gm-header-right">
        <div className="gm-date-badge">
          <span className="gm-date-label">Period</span>
          <span className="gm-date-value">{fromDate} → {toDate}</span>
        </div>
        <div className="gm-status-dot">
